  ...
  $.fn[pluginName] = function (options) {
    ...
    var Plugin = {
          ...
          enable: function () {
            var enableLock = function (tablePart) {
              ...
              var lockLeft = $('<div/>').addClass(
                pfx + 'datatable-lock ' + pfx + 'datatable-lock-left'
              )
              var lockScroll = $('<div/>').addClass(
                pfx + 'datatable-lock ' + pfx + 'datatable-lock-scroll'
              )
              var lockRight = $('<div/>').addClass(
                pfx + 'datatable-lock ' + pfx + 'datatable-lock-right'
              )
        ...
        $(datatable.tableBody)
          ...
          .on('mouseenter', function () {
            ...
            $(row)
              ...
              .parent()
              .find('.' + pfx + 'datatable-row:nth-child(' + index + ')')
              .addClass(pfx + 'datatable-row-hover')
          })
              ...
              .each(function (tdi, td) {
                ...
                if (typeof column !== 'undefined') {
                  ...
                  if (
                    ...
                    if (
                      $(td).find('.' + pfx + 'datatable-toggle-subtable')
                        .length > 0
                    )
                      return
                ...
                if (dataWidth === 'auto') {
                  ...
                  if (Plugin.maxWidthList[field]) {
                    ...
                    var cells = $(datatable.table).find(
                      '.' + pfx + 'datatable-cell[data-field="' + field + '"]'
                    )
        ...
        var scroll = {
          ...
          init: function () {
            ...
            if (options.layout.scroll) {
              ...
              if (
                $(scrollable).find('.' + pfx + 'datatable-row').length > 0 &&
                $(scrollable).length > 0
              ) {
                ...
                $(datatable.tableBody).find('.' + pfx + 'datatable-row')
                  .length > 0
              ) {
                scroll.scrollHead = $(datatable.tableHead).find(
                  '> .' + pfx + 'datatable-row'
        ...
        var pg = {
          ...
          populate: function () {
            ...
            pg.pager = $('<div/>').addClass(
              pfx + 'datatable-pager ' + pfx + 'datatable-paging-loaded'
            )
            // numbering links
            ...
            $('<li/>')
              .append(
                $('<input/>')
                  .attr('type', 'text')
                  .addClass(pfx + 'datatable-pager-input form-control')
            ...
            if (Plugin.getOption('toolbar.items.info')) {
              pg.pagerLayout['info'] = $('<div/>')
                .addClass(pfx + 'datatable-pager-info my-2 mb-sm-0')
                .append($('<span/>').addClass(pfx + 'datatable-pager-detail'))
            }
          ...
          addPaginateEvent: function (e) {
            ...
            $(datatable)
              ...
              .on(pg.paginateEvent, function (e, meta) {
                ...
                $(pagerNumber)
                  .find('.' + pfx + 'datatable-pager-link-active')
                  .removeClass(pfx + 'datatable-pager-link-active')
                $(pagerNumber)
                  .find(
                    '.' +
                      pfx +
                  ...
                  .addClass(pfx + 'datatable-pager-link-active')

                // set next and previous link page number
                $(pagerNumber)
                  .find('.' + pfx + 'datatable-pager-link-prev')
                  .attr('data-page', Math.max(meta.page - 1, 1))
                $(pagerNumber)
                  .find('.' + pfx + 'datatable-pager-link-next')
                  .attr('data-page', Math.min(meta.page + 1, meta.pages))

                // current page input value sync
                $(pg.pager).each(function () {
                  $(this)
                    .find('.' + pfx + 'datatable-pager-input[type="text"]')
                ...
                if (util.isInResponsiveRange(mode)) {
                  switch (mode) {
                    ...
                    case 'mobile':
                      $(pagerInput).show()
                      $(pagerNumber)
                        .find('.' + pfx + 'datatable-pager-link-more-prev')
                        .closest('li')
                        .hide()
                      $(pagerNumber)
                        .find('.' + pfx + 'datatable-pager-link-more-next')
                        .closest('li')
                        .hide()
                      $(pagerNumber)
                        .find('.' + pfx + 'datatable-pager-link-number')
                        .closest('li')
                        .hide()
                      break
                  }
          ...
          paginationUpdate: function () {
            ...
            if (pg.meta.page === 1) {
              $(pagerFirst)
                .attr('disabled', true)
                .addClass(pfx + 'datatable-pager-link-disabled')
              $(pagerPrev)
                .attr('disabled', true)
                .addClass(pfx + 'datatable-pager-link-disabled')
            } else {
              $(pagerFirst)
                .removeAttr('disabled')
                .removeClass(pfx + 'datatable-pager-link-disabled')
              $(pagerPrev)
                .removeAttr('disabled')
                .removeClass(pfx + 'datatable-pager-link-disabled')
            }
      ...
      columnHide: function () {
        ...
        $.each(options.columns, function (i, column) {
          if (
            ...
            var tds = $.grep(
              $(datatable.table).find('.' + pfx + 'datatable-cell'),
              function (n, i) {
      ...
      setupSubDatatable: function () {
        ...
        if (
          $(datatable.table).find('.' + pfx + 'datatable-subtable').length > 0
        )
          return
        ...
        var toggleSubTable = function (e) {
          ...
          if ($(subTableRow).length === 0) {
            ...
            subTableRow = $('<tr/>')
              .addClass(
                pfx + 'datatable-row-subtable ' + pfx + 'datatable-row-loading'
              )
              .hide()
              .append(
                $('<td/>')
            ...
            $(clonedCells).each(function () {
              ...
              if (typeof column === 'undefined' || column.visible !== false) {
                $(detailSubTable).append(
                  $('<tr class="' + pfx + 'datatable-row"></tr>')
                    .append(
                      $('<td class="' + pfx + 'datatable-cell"></td>').append(
          ...
          if (hiddenExist) {
            ...
            $(datatable.tableBody)
              ...
              .each(function () {
                // if no toggle yet
                if (
                  $(this).find('.' + pfx + 'datatable-toggle-detail').length ===
                  0
                ) {
                  // add toggle
                  $(this).prepend(
                ...
                if (
                  ...
                  $(datatable.tableHead)
                    .find('.' + pfx + 'datatable-toggle-detail')
                    .find('span')
                }
              })
          }
      ...
      sortColumn: function (header, sort, int) {
        ...
        if (hIndex !== -1) {
          rows = $(datatable.tableBody)
            .find('.' + pfx + 'datatable-lock:nth-child(' + (hIndex + 1) + ')')
            .find('.' + pfx + 'datatable-row')
        }
        ...
        var sortObj = {
          ...
          setIcon: function () {
            ...
            var td = $(datatable.tableHead)
              .find(
                '.' + pfx + 'datatable-cell[data-field="' + meta.field + '"]'
              )
      ...
      search: function (value, columns) {
        ...
        delay(function () {
          ...
          datatable.setDataSourceParam(
            'pagination',
            Object.assign({}, datatable.getDataSourceParam('pagination'), {
              page: 1
            })
          )
      ...
      rows: function (selector) {
        if (Plugin.isLocked()) {
          Plugin.nodeTr = Plugin.recentNode = $(datatable.tableBody)
            .find(selector)
            .filter(
              '.' + pfx + 'datatable-lock-scroll > .' + pfx + 'datatable-row'
            )
        } else {
          Plugin.nodeTr = Plugin.recentNode = $(datatable.tableBody)
            .find(selector)
          ...
          if (Plugin.recentNode === Plugin.nodeCols) {
            ...
            if (Plugin.isLocked()) {
              ...
              if (scrollColumns) {
                ...
                $(Plugin.recentNode).closest('.' + pfx + 'datatable-lock-right')
                  .length
              ) {
